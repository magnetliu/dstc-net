...
_C.MODEL.SWIN = CN()
_C.MODEL.SWIN.PATCH_SIZE = (4,4,4)
_C.MODEL.SWIN.IN_CHANS = 1
_C.MODEL.SWIN.EMBED_DIM = 64
_C.MODEL.SWIN.DEPTHS =[2, 2, 6, 2]
_C.MODEL.SWIN.NUM_HEADS =[4, 8, 16, 32]
_C.MODEL.SWIN.DILATED =[True, True, False, False]
_C.MODEL.SWIN.LAMBDA1 = 0.9
...
_C.MODEL.VIT = CN()
_C.MODEL.VIT.PATCH_SIZE = (16,16,16)
